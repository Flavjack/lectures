...
summary(hyper)
plotRF(hyper)
# browseURL("https://bioinformaticsworkbook.org/dataAnalysis/GenomeAssembly/GeneticMaps/assets/CML247_Fig-6a_recombination-fraction-combined.png")
...
Base de datos simulado de 300 individuos en F2 con 100 marcadores en 5 cromosomas (grupos de recombinación).
